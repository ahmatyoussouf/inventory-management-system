...
Console-based inventory management system built in Java. Supports product tracking, stock alerts, and discount application.
Inventory Management System
...
bash   git clone https://github.com/ahmatyoussouf/inventory-management-system.git
cd inventory-management-system

Compile the Java file:
bash javac InventorySystem.java

Run the program:
bash java InventorySystem
